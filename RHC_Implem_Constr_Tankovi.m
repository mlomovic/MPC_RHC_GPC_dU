...
b = zeros(4*Nc*n_in,1);
%for i = 1:Nc
 %   b(i:n_in,1) = deltau_min;
  %  b(i+Nc:n_in,1) = -deltau_max;
   % b(i+2*Nc*n_in,1) = u_max-u;
    %b(i+3*Nc*n_in,1) = -u_min+u;
%end
%b=[3;3;3;3;3;3;1.5;1.5;1.5;1.5;1.5;1.5;4-u;4-u;4-u;4-u;4-u;4-u;3-u;3-u;3-u;3-u;3-u;3-u]
...
b=[3; 3; 3; 3; 3; 3; 1.5; 1.5; 1.5; 1.5; 1.5; 1.5; 4-u(1); 4-u(2); 4-u(1); 4-u(2); 4-u(1); 4-u(2); 3-u(1); 3-u(2); 3-u(1); 3-u(2); 3-u(1); 3-u(2)];
